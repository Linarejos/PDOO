...
module Civitas
  class CivitasJuego
    ...
    def siguientepasocompletado(operacion)
      @estado = @gestorestados.siguienteestado(@jugadores[@indiceJugadorActual])
    end
    ...
    def inicializarmazosorpresas(tablero)
      ...
      @mazo.almazo(Sorpresa.new_sorpresas(Civitas::TipoSorpresa::PORJUGADOR, -50, 'Dale dinero a los demás'))
